                ...
                <div className="relative isolate">
                    ...
                    <div className="md:flex md:justify-between relative">
                        <div className="mb-6 md:mb-0 max-w-96">
                            <Link href="/" className="flex items-center -mt-5">
                                <Image src={ urlForImage(theme.logo) }
                                    ...
                                    width={64}
                                    height={64} />
                                <span className="self-center text-2xl font-semibold whitespace-nowrap" style={{ color: footer.titleColorCode }}>{theme.websiteName}</span>
                            </Link>
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            {footer.Menus.map((item: any) => (
                                <div key={item.title}>
                                <h2 className="mb-6 text-sm font-semibold uppercase" style={{ color: footer.titleColorCode }}>{item.title}</h2>
                                <ul style={{ color: footer.menuColorCode }}>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                            ...
                            { theme.socialLinks.instagram && <Link href={theme.socialLinks.instagram} className="hover:opacity-80" style={{ color: footer.menuColorCode }}>
                            ...
                            { theme.socialLinks.twitter && <Link href={theme.socialLinks.twitter} className="hover:opacity-80" style={{ color: footer.menuColorCode }}>
                            ...
                            { theme.socialLinks.linkedin && <Link href={theme.socialLinks.linkedin} className="hover:opacity-80" style={{ color: footer.menuColorCode }}>
