...
const Nav = (props: any) => {
    ...
    return(
      <section className='relative nav'>
        ...
        <a className='fixed bottom-5 right-32 bg-[#25d366] rounded-full p-2 z-10 shadow-lg' href={`https://wa.me/${theme.socialLinks.whatsapp}`}>
        ...
        <script async src='https://embed.tawk.to/65db26f09131ed19d9717717/1hng107ci' />
      </section>
    )
}
