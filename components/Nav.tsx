...
/*const Nav = () => {
    ...
    return(
      <section className='relative nav'>
          ...
          <nav className="flex items-center justify-between px-6 py-2 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
              <Link href="/" className="-m-1.5 p-1.5">
                <span className="sr-only">Supreme Transfer</span>
                <Image
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              {NAVIGATION.map((item) => (
                <div key={item.name}>
                  {item.submenu.length == 0 && <Link href={item.href} className="text-sm font-semibold leading-6 text-black">
                    {item.name}
                  </Link>}
                  {item.submenu.length != 0 && <Popover className="relative">
            ...
            <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-2">
              <Link href={ PHONE_LINK } className="flex items-center gap-2 rounded-full  px-3.5 py-1 text-sm font-semibold  shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900 text-white bg-gray-900">
        ...
        <a className='fixed bottom-5 right-5 bg-[#25d366] rounded-full p-2 z-10 shadow-lg' href={WHATSAPP_LINK}>
