  ...
  return (
    <div>
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 pt-24 sm:px-6 sm:pt-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <dl className="mt-10 grid grid-cols-1">
            {portsChauffeur.points.map((point: any,i:any) => (
        ...
        <Image
            src={urlForImage(portsChauffeur.images.image1)}
            alt={portsChauffeur.heading}
            width={200}
            height={200}
            className="rounded-lg bg-gray-100 w-full aspect-square object-cover"
          />
          <Image
            src={urlForImage(portsChauffeur.images.image2)}
            alt={portsChauffeur.heading}
            width={200}
            height={200}
            className="rounded-lg bg-gray-100 w-full aspect-square object-cover"
          />
          <Image
            src={urlForImage(portsChauffeur.images.image3)}
            alt={portsChauffeur.heading}
            width={200}
            height={200}
            className="rounded-lg bg-gray-100 w-full aspect-square object-cover"
          />
          <Image
            src={urlForImage(portsChauffeur.images.image4)}
            alt={portsChauffeur.heading}
            width={200}
            height={200}
            className="rounded-lg bg-gray-100 w-full aspect-square object-cover"
      ...
      <div className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        {portsChauffeur.sections.map((section: any, i: any) => (
          <div  key={i}>
            {!section.leftimage && 
